...
# Only capture stderr here to reduce log verbosity. 
RUN cd /minecraft-workspace/ && java -jar BuildTools.jar 2>&1 >/dev/null
RUN mv /minecraft-workspace/spigot-*.jar /minecraft
